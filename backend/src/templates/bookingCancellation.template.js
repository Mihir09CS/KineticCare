...
<title>KineticCare Booking Cancellation</title>
</head>
...
Your booking for <strong>${serviceName}</strong> has been cancelled as requested.
</p>
...
<tr>
<td style="color:#64748b;font-weight:bold;">Scheduled Date:</td>
<td style="color:#0f172a;">${date}</td>
</tr>
<tr>
<td style="color:#64748b;font-weight:bold;">Scheduled Time:</td>
<td style="color:#0f172a;">${startTime}</td>
</tr>
</table>

<p style="color:#475569;font-size:15px;line-height:1.6;">
If this cancellation was done in error or you wish to schedule a new appointment, please visit our platform to select a new slot.
</p>
